...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'initial'          => ['type' => 'varchar', 'constraint' => 10, 'null' => true], // Inisial
            'sub_section'      => ['type' => 'varchar', 'constraint' => 100, 'null' => true], // Sub Bagian
            'section'          => ['type' => 'varchar', 'constraint' => 100, 'null' => true], // Bagian
            'division'         => ['type' => 'varchar', 'constraint' => 100, 'null' => true], // Divisi
            'directorate'      => ['type' => 'varchar', 'constraint' => 100, 'null' => true], // Direktorat
            'position'         => ['type' => 'varchar', 'constraint' => 100, 'null' => true], // Jabatan

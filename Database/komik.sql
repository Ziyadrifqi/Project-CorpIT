...
--
-- Host: db
-- Generation Time: Jan 23, 2025 at 04:02 AM
...
CREATE TABLE `absensi` (
  ...
  `status` enum('pending','hadir','pulang') COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `category_id` int DEFAULT NULL,
  `judul_kegiatan` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kegiatan_harian` text COLLATE utf8mb4_general_ci,
...
INSERT INTO `absensi` (`id`, `user_id`, `tanggal`, `jam_masuk`, `jam_keluar`, `tanggal_keluar`, `status`, `created_at`, `updated_at`, `category_id`, `judul_kegiatan`, `kegiatan_harian`, `no_tiket`) VALUES
...
INSERT INTO `admin_activities` (`id`, `task`, `location`, `start_time`, `end_time`, `activity_date`, `description`, `created_at`, `updated_at`, `user_id`) VALUES
(1, 'monitoring', 'TB simatupang', '09:00:00', '14:00:00', '2025-01-15', 'Melakukan kegiatan', '2025-01-15 03:48:45', '2025-01-16 02:45:18', 1),
(3, 'Survei', 'Bogor', '09:00:00', '17:00:00', '2025-01-16', 'melakukan survei kepada', '2025-01-16 07:33:09', '2025-01-16 07:33:09', 3);
...
CREATE TABLE `article_distributions` (
  `id` int NOT NULL,
  `article_id` int NOT NULL,
  `target_type` enum('directorate','division','department','sub_department') COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `fileuploads` (`id`, `title`, `description`, `author`, `file_path`, `created_at`, `updated_at`, `status`) VALUES
(1, 'Pengumuman Indosat Run', 'saat ini', 'ZiyadRifqi', 'public/fileupload/1731239156_9185c19da18efa4ab3c4.pdf', '2024-11-10 11:45:56', '2024-12-11 02:31:02', 'published'),
(6, 'Agenda Bulan Pertengahan November 2024', 'Edaran', 'Ziyad', 'public/fileupload/1732799064_1d5c42a3dcdf46531c48.pdf', '2024-11-15 08:08:35', '2024-12-11 02:30:33', 'published'),
(11, 'Pentingnya Transformasi Bisnis Digital​​ perusahaan', 'Melakukan kegiatan yang sangat penting untuk perusahaan ', 'minji', 'public/fileupload/1733819087_f403560aa78066b3a9f7.pdf', '2024-12-10 08:24:47', '2024-12-10 08:24:47', 'published');
...
CREATE TABLE `file_distributions` (
  `id` int NOT NULL,
  `target_id` int NOT NULL,
  `target_type` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fileuploads_id` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(46, 1, 'sub_department', '2024-12-10 08:24:47', 11),
...
(20, 'Attendance Categories', 'fas fa-tasks', 'Absensi/categories', 19, 2, 1, '2024-11-19 10:18:01', '2025-01-15 08:00:11'),
(21, 'Attendance history', 'fas fa-history', 'absensi/history', 19, 3, 1, '2024-11-20 04:49:03', '2024-11-20 07:48:39'),
(22, 'User Attendance List', 'fas fa-history', 'absensi/superadmin/history', 19, 1, 1, '2024-11-21 07:06:02', '2024-11-21 08:00:49'),
...
(26, 'Field Activities', 'fas fa-tasks', 'admin/activity', 25, 1, 1, '2025-01-14 02:44:28', '2025-01-16 02:12:05'),
(27, 'Admin Activities History', 'fas fa-clipboard-list', 'activity/history', 25, 1, 1, '2025-01-14 09:29:34', '2025-01-15 03:52:09');
...
CREATE TABLE `monitoring_tickets` (
  `id` int NOT NULL,
  `user_id` int UNSIGNED NOT NULL,
  `ticket_number` varchar(6) COLLATE utf8mb4_general_ci NOT NULL,
  `subject` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `status_ticket` enum('open','closed','resolved','rejected','stopclock') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'open',
  `status_approval` enum('pending','Approval Not Provided','successfully approval') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending',
  `resolution` text COLLATE utf8mb4_general_ci,
  `conversation` text COLLATE utf8mb4_general_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `users` (
  ...
  `initial` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `position` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `user_image` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'default.png',
...
INSERT INTO `users` (`id`, `email`, `username`, `fullname`, `initial`, `position`, `user_image`, `password_hash`, `reset_hash`, `reset_at`, `reset_expires`, `activate_hash`, `status`, `status_message`, `active`, `force_pass_reset`, `created_at`, `updated_at`, `deleted_at`, `directorate_id`, `division_id`, `department_id`, `sub_department_id`) VALUES
(1, 'ziyad@gmail.com', 'ZiyadRifqi', 'ZiyadRifqi Permana', NULL, 'Programmer', '1731054156_e3b6a61f7842719fc65b.jpg', '$2y$10$uJvfrqNeXtBFqI4jMWctqOM0C0rurnq5IylD48a5dWhTPyJoEa75O', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2024-10-18 02:15:11', '2024-10-18 02:15:11', NULL, 1, 1, 1, 1),
(2, 'Rassya@gmail.com', 'Rassya', 'Rassya putra', 'RSY', 'Manager', 'default.png', '$2y$10$BG2KPonEID0IuaaVqTxDkO7RcVoHGIoN/bbmqS5lyVQFgMsbavUgK', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2024-10-18 02:32:13', '2024-10-18 02:32:13', NULL, 1, 1, 1, 1),
(3, 'raihan@gmail.com', 'Raihan Putra', 'Raihan Putra', 'RPA', 'Officer', 'default.png', '$2y$10$btcpZQMRF0Qh5HxR5dPf2.NI5gfDdJkd/iUPqIpI16gDu5fZKWn0O', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2024-10-29 06:36:27', '2024-10-29 06:36:27', NULL, 2, 2, 3, 3),
(5, 'syakira02@gmail.com', 'syakira', NULL, NULL, NULL, 'default.png', '$2y$10$w7jofpeiSGUtmwcb52W7Z.hAFb2htwwyutPmjzla0zEptNmPOFZXe', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2024-11-18 03:52:45', '2024-11-18 03:52:45', NULL, NULL, NULL, NULL, NULL);

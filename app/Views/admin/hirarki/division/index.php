    ...
    <div class="card-body">
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                <a href="<?= base_url('admin/hirarki/division/create'); ?>" class="btn btn-primary float-end">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover table-bordered" id="divisions">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($divisions as $div) : ?>
                                <tr class="text-center">
                                    ...
                                    <td><?= esc($div['name']); ?></td>
                                    <td>
                                        <a href="<?= base_url('admin/hirarki/division/edit/' . $div['id']); ?>" class="btn btn-warning btn-sm">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <form action="<?= base_url('admin/hirarki/division/delete/' . $div['id']); ?>" method="post" style="display: inline-block;">
                                            <?= csrf_field(); ?>
